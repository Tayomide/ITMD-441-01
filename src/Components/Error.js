...
export const Error = ({error, display=true}) => {
  ...
  useEffect(() => {
    ...
    <Link key="7" to="./weather" className={display?"display":""}>Still skeptical? Check out our API!</Link>])
    ...
    <Link key="8" to="./weather" className={display?"display":""}>Still skeptical? Check out our API!</Link>])
      ...
      <Link key="9" to="./weather" className={display?"display":""}>Still skeptical? Check out our API!</Link>])
    }
    ...
    <Link key="10" to="./weather" className={display?"display":""}>Still skeptical? Check out our API!</Link>])
  }, [error, display])
  return (
    <Container>
